...
const OnboardingLayout = ({
  ...
  return (
    <section className='w-full h-dvh p-[clamp(12px,5vw,56px)] pt-0 flex flex-col bg-linear-to-b from-gradient-1 via-gradient-2 to-gradient-3'>
      ...
      <main className="border-[1.5px] sm:mt-10 p-[clamp(12px,5vw,56px)] w-full sm:w-[90vw] h-full mx-auto flex flex-col justify-between items-center bg-white rounded-xl shadow-xl transition-all duration-500 ease-in-out overflow-hidden relative">
        {children}
      </main>
    </section>
  )
